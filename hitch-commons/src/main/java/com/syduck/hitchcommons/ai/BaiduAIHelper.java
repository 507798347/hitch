package com.syduck.hitchcommons.ai;
...
public class BaiduAIHelper {
    ...
    public AIResult getLicensePlateMap(String imageurl) {
        String resultData = getCacheData(imageurl, this::getLicensePlateData);
    ...
    public AIResult getIdCardMap(String imageurl) {
        String resultData = getCacheData(imageurl, this::getIdCardData);
    ...
    private String getCacheData(String imageURL, Function<String, String> function) {
        ...
        //从redis中获取结果
        String result = hashOperations.get(HitchConstants.BAIDU_AI_RESULT, imageURL);
        //结果不为空返回数据
        ...
        checkResult(result);
        //校验通过设置缓存
        hashOperations.put(HitchConstants.BAIDU_AI_RESULT, imageURL, result);
        //返回结果数据
        return result;
    }
