...
public class APIController {
    ...
    public APIController(AccountHandler accountHandler){
    ...
    @PostMapping("/login")
    public ResponseVO login(@Validated(Group.Select.class) @RequestBody AccountVO accountVO) {
    ...
    public ResponseVO verifyToken(@RequestHeader(HitchConstants.SESSION_TOKEN_KEY) String sessionID) {
