package com.syduck.hitchstorage.handler;
...
import com.syduck.hitchstorage.configuration.MinioConfig;
import com.syduck.hitchstorage.mapper.AttachmentMapper;
...
public class AttachmentHandler {
    ...
    private AttachmentPO getAttachmentPO(MultipartFile file) throws IOException {
        ...
        attachmentPO.setLength(file.getSize());
